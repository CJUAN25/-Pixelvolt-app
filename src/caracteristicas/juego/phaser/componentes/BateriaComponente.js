...
/**
 * Componente Batería - Representa una fuente de energía DC en el juego
 * Extiende Phaser.GameObjects.Container para agrupar imagen y puntos de conexión
 */
class BateriaComponente extends Phaser.GameObjects.Container {
  /**
  ...
  eliminarCablesConectados(scene) {
    if (scene && scene.conexionesPorComponente && scene.conexionesPorComponente.has(this)) {
      ...
      console.log(`🗑️ Batería eliminada con ${cablesAEliminar.length} cables conectados`);
    }
  }
}

export default BateriaComponente;
