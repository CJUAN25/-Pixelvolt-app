...
/**
 * Componente Resistencia - Representa una resistencia fija en el juego
 * Extiende Phaser.GameObjects.Container para agrupar imagen y puntos de conexión
 */
class ResistenciaComponente extends Phaser.GameObjects.Container {
  /**
  ...
  eliminarCablesConectados(scene) {
    if (scene && scene.conexionesPorComponente && scene.conexionesPorComponente.has(this)) {
      ...
      console.log(`🗑️ Resistencia eliminada con ${cablesAEliminar.length} cables conectados`);
    }
  }
}

export default ResistenciaComponente;
